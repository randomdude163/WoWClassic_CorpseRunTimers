CRT_GHOST_SPEED_MODIFIER = 1.25
CRT_BASE_RUNNING_SPEED = 7         -- yards per second
CRT_CORPSE_RESURRECTION_RANGE = 40 -- yards
CRT_WISP_SPIRIT_MODIFIER = 1.50    -- 50% additional speed for Night Elf ghosts
...
CRT_ZoneData = {
    ...
    ["14"] = {  -- Durotar
        ...
        graveyards = {
            { x = 44.2, y = 69.4 }, -- Valley of Trials
            { x = 57.4, y = 73.2 }, -- Sen'jin Village
            { x = 53.6, y = 44.6 }, -- Razor Hill
            { x = 47.0, y = 17.6 }, -- Orgrimmar
        }
